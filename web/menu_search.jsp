...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/showProductByPage" style="color:#b4d76d;width: 110px;height:30px;line-height: 30px;
float: right;position: relative;top: -10px;left:0px">全部商品目录</a>
</div>
<div id="divsearch">
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:right; padding-right:220px">
				<input type="text" name="textfield" class="input_search" id="textfield" value="请输入书名"
					   onmouseover="this.focus();"
					   onclick="my_click(this, 'textfield');"
					   onBlur="my_blur(this, 'textfield');"/>
					<a class="top_sousuo1" href="#">
						<img class="top_sousuo" src="images/search1.png" onclick="search()"/>
					</a>
			</td>
		</tr>
	</table>
