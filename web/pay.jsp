...
<body>
	...
	<form action="${pageContext.request.contextPath}/pay" method="post" >
		订单号：<INPUT TYPE="text" NAME="orderid" style="border:0;
		background-image: linear-gradient(-225deg, #E3FDF5 0%, #FFE6FA 100%);color: red;font-size: 16px;width: 300px;" value="${param.id}"><br/>
		支付金额：<INPUT TYPE="text" NAME="money"  style="border:0;
		background-image: linear-gradient(-225deg, #E3FDF5 0%, #FFE6FA 100%); width: 40px;color: red;" value="${param.money}">元
		<br/>
		<br/>
		<div class="divBank">
			...
			<div  style="margin: 40px;">
				<INPUT class="zhifubutton" style="border: 0;font-size:19px;height:50px;width: 150px;background-color: red;color: white;
font-weight: bolder;border-radius: 7px;" TYPE="submit" value="确定支付">
			</div>
		</div>
	</form>
	</div>
