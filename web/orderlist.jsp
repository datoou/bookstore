...
<body class="main">
	<!-- 使用了自定义标签 -->
	<p:user/>
	<div style="text-align:right;font-size: 16px; margin:50px 230px -30px 0px">
		<a style="font-size: 16px;"href="${pageContext.request.contextPath }/index.jsp">首页</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;
		订单查询
	</div>
	<div id="divpagecontent" style="margin-top: 50px;">
		<table width="100%" border="0" cellspacing="0" style="background-image: linear-gradient(-225deg, #E3FDF5 0%, #FFE6FA 100%);border: 0px;border-radius: 15px;">
			<tr>
				<td>

					<table cellspacing="0" class="infocontent" style="background-image: linear-gradient(-225deg, #E3FDF5 0%, #FFE6FA 100%);border: 0px">
						<tr>
							<td style="padding:20px;font-size: 15px;"><p><b>我的订单</b></p>
								<p>
